> **Independent fork.** This repository is an independent fork maintained by **MMPWorks LLC** and is
> **NOT affiliated with, endorsed by, sponsored by, or approved by the .NET Foundation or Microsoft.**
> It is a fork of [dotnet-architecture/eShopOnWeb](https://github.com/dotnet-architecture/eShopOnWeb)
> (© .NET Foundation and Contributors, MIT). The original license is preserved in `LICENSE`. MMPWorks
> modified this fork to demonstrate a Serilog → Herald.OSS logging migration. See `FORK-NOTICE.md`.
